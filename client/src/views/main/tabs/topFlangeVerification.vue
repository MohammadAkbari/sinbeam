...
apiServise.callApi(props.links, constants.topFlangeVerification.getTopFlangeVerification).then((data: FlangeVerification) => {
...
<template>
    <div class="col col-8">
        ...
        <div class="row" style=" margin: 0 20px;">
            <div class="col col-md-12" style="max-height: 200px;  text-align: center;">
                <div class="row" style="font-weight: bold; background-color: #d1d1d1; border-bottom: solid 2px rgb(126, 126, 126);">
